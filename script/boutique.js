...
(() => {
  window.storeItemsData = [
    ...
    { name: "Hypermarcher de croquettes", price: 1000, mult: 0, auto: 20, owned: 0, icon: "script/image/hypermarcher.png" },
    { name: "Entrepot de croquettes", price: 5000, mult: 0, auto: 50, owned: 0, icon: "script/image/entrepot.png" },
    { name: "Usine de croquettes", price: 10000, mult: 0, auto: 100, owned: 0, icon: "script/image/usine.png" },
    { name: "Temple à croquettes", price: 50000, mult: 0, auto: 300, owned: 0, icon: "script/image/temple.png" },
    { name: "Dimension de croquettes", price: 50000, mult: 0, auto: 500, owned: 0, icon: "script/image/dimension.png" },
    { name: "Univers de croquettes", price: 100000, mult: 0, auto: 1000, owned: 0, icon: "script/image/univers.png" },
    { name: "Galaxy de croquettes", price: 500000, mult: 0, auto: 5000, owned: 0, icon: "script/image/galaxy.png" }
  ];
